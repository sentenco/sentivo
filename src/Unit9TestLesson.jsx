    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Unit 9 Test</h1></span>
          <p className="slide-p">Let's see everything you learned about animals!</p>
        </div>
      ),
    },
      ...
      body: (
        <>
          ...
          <div className="word-row">
            ...
            <Pic src={null} label="bird" size={62} onZoom={onZoom} />
            ...
            <Pic src={null} label="giraffe" size={62} onZoom={onZoom} />
          </div>
        </>
      ),
    },
