    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">Free practice: mom, dad, sister, brother, and "This is my..."</p>
        </div>
      ),
    },
    // 2: Hello & Free Start
    ...
    // 5: Family Detective
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="unknown family scene" size={110} onZoom={onZoom} />
    ...
    // 7: HIGHLIGHT Build My Family! (round 2)
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="brother" size={90} onZoom={onZoom} />
