// ASCEND Contract Negotiation — Lesson 4 — "The Reversal" — Reversal
...
export default {
  ...
  warmup: {
    kind: "synonyms",
    items: [
      { pre: "The contract includes a clause for raising prices later — an ", word: "automatic price increase rule", post: ".", upgraded: "escalation clause" },
      { pre: "They told us this was their ", word: "last and final price", post: ".", upgraded: "best and final offer" },
      { pre: "A good deal should create ", word: "value for both sides", post: ".", upgraded: "mutual benefit" },
    ],
  },
  ...
  gimmick: {
    ...
    position: "In a negotiation, you should always reveal your walk-away point to build trust with the other side.",
  },
