    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Unit 6 Challenge!</h1></span>
          <p className="slide-p">Let's see everything you know: body parts, describing, and -at / -og.</p>
        </div>
      ),
    },
    // 2: Body Parts Check
