    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Colorful Letters!</h1></span>
          <p className="slide-p">Today we learn the letters S, T, U and our first colors.</p>
