    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Unit 2 Challenge!</h1></span>
          <p className="slide-p">Let's see everything you know: numbers 1 to 10, letters J to R, and "How many?"</p>
