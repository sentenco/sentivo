    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Unit 5 Challenge!</h1></span>
          <p className="slide-p">Let's see everything you know: mom, dad, sister, brother, and "This is my..."</p>
        </div>
      ),
    },
    // 2: Test Welcome
