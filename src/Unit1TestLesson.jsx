    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Unit 1 Challenge!</h1></span>
          <p className="slide-p">Let's see everything you know: A to I, greetings, and feelings.</p>
