    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">Today we bring it all together: bag items, classroom objects, and instructions.</p>
        </div>
      ),
    },
    // 2: School Warm-Up
      ...
      body: (
        <>
          ...
          <div className="word-row">
            <Pic src={null} label="pen" size={80} onZoom={onZoom} />
            <Pic src={null} label="book" size={80} onZoom={onZoom} />
          </div>
        </>
      ),
    },
    // 4: My Classroom
    {
      ...
      body: (
        <>
          ...
          <div className="word-row">
            <Pic src={null} label="desk" size={70} onZoom={onZoom} />
            <Pic src={null} label="chair" size={70} onZoom={onZoom} />
            <Pic src={null} label="board" size={70} onZoom={onZoom} />
          </div>
        </>
      ),
    },
