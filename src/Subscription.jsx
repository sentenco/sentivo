...
const TIERS = [
  ...
  },
  {
    key: "pro",
    name: "Pro",
    tagline: "The full curriculum, every level.",
    price: "Coming soon",
    cta: "Upgrade to Pro",
    accent: "coral",
    highlighted: true,
    features: [
      "Everything in Free",
      "Speaking, Reading, Grammar, Vocabulary, Writing, Listening -- full depth",
  ...
  },
  {
    key: "pro_plus",
    name: "Pro+",
    tagline: "AI tools for the moments you need an answer now.",
    price: "Coming soon",
    cta: "Upgrade to Pro+",
    accent: "navy",
    features: [
