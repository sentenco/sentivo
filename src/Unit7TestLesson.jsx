    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Unit 7 Test</h1></span>
          <p className="slide-p">Let's see everything you learned about school!</p>
        </div>
      ),
    },
    // 2: Warm-Up
      ...
      body: (
        <>
          ...
          <div className="word-row">
            ...
            <Pic src={null} label="bag" size={78} onZoom={onZoom} />
          </div>
        </>
      ),
    },
