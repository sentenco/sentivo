    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Yummy Food!</h1></span>
          <p className="slide-p">Today we learn food words and the letters "in"!</p>
        </div>
      ),
    },
    ...
    // 4: Meet the Food (rice, egg)
    {
      ...
      body: (
        <>
          ...
          <div className="word-row">
            <WordCard src={null} word="Rice" label="rice" onZoom={onZoom} />
