// ASCEND Contract Negotiation — Lesson 3 — "Concede-then-Counter" — Counter
...
export default {
  ...
  warmup: {
    kind: "synonyms",
    items: [
      { pre: "They had more ", word: "power in the discussion", post: " than we expected.", upgraded: "leverage" },
      { pre: "We're willing to ", word: "give a little on this point", post: ".", upgraded: "concession" },
      { pre: "Let's put the terms in a ", word: "short summary document first", post: ".", upgraded: "term sheet" },
    ],
  },
  ...
  gimmick: {
    ...
    claims: [
      "Your price is simply too high for what you're offering.",
      "We need this delivered faster than your standard timeline.",
      "Our legal team won't accept this liability clause as written.",
    ],
  },

  closing: { kind: "words", heading: "Before next lesson",
    body: "Write these down and keep them close — you'll need them next lesson.",
    words: ["escalation clause", "best and final offer", "mutual benefit"] },
  ...
  teacherGuide: {
    ...
    gimmick: {
      ...
      say: [
        ...
        "I'm going to give you three pushbacks a counterparty might raise. Respond to each using the pattern.",
      ],
      do: [
