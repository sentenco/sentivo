// RELAY Lesson 3 — "At the Office" — Small talk — Adults
...
export default {
  ...
  bounce: {
    ...
    rounds: [
      { question: "How was your commute today?", missingBeatHint: "Add a detail" },
      { question: "Do you usually take a lunch break?", missingBeatHint: "Add a reason" },
  ...
  yourTurn: {
    scenario: "You're getting coffee in the break room and a colleague starts chatting. Keep it going for at least 4 turns.",
    teacherRole: "A colleague in the break room",
    opener: "Busy morning, huh? How's your day going so far?",
  },

  pushIt: {
    prompt: "One harder one — “Do you think open offices are a good idea?” Still three beats.",
  },
  ...
  teacherGuide: {
    cover: {
      ...
      say: ["Same rule: Answer, Add, Ask. Today's topic is work and the office."],
    ...
    yourturn: {
      ...
      say: ["Now a real one — I'm a colleague in the break room making small talk. Keep it going."],
      do: [
