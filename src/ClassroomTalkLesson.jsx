    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Classroom Talk!</h1></span>
          <p className="slide-p">Today we learn to give and follow classroom instructions!</p>
        </div>
      ),
    },
