...
export const TEENS_UNITS = {
  A1: [
    ...
    },
    {
      ...
      lessons: [
        { num: 1, title: "Social Media and Tech", focus: "Name basic social media and technology words" },
        { num: 2, title: "Online Habits", focus: "Say simple things you do online" },
        { num: 3, title: "Messages and Communication", focus: "Use simple communication phrases online" },
        { num: 4, title: "Tech Questions", focus: "Answer simple questions about technology use" },
        { num: 5, title: "Unit Review", focus: "Summative review", isTest: true },
      ],
    },
    {
      ...
      lessons: [
        { num: 1, title: "Weekend Plans", focus: "Say simple weekend plans" },
        { num: 2, title: "Making Simple Plans", focus: "Use I'm going to... for plans" },
        { num: 3, title: "Invitations and Responses", focus: "Make and answer a simple invitation" },
        { num: 4, title: "Talking About the Weekend", focus: "Answer questions about weekend plans" },
        { num: 5, title: "Unit Review", focus: "Summative review", isTest: true },
      ],
    },
  ],
