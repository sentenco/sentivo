    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Animal Friends!</h1></span>
          <p className="slide-p">Today we meet cat, dog, bird, and fish!</p>
        </div>
      ),
    },
      ...
      body: (
        <>
          ...
          <div className="word-row">
            ...
            <WordCard src={null} word="Bird" label="bird" onZoom={onZoom} />
