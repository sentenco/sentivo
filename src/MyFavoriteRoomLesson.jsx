    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">My Favorite Room!</h1></span>
          <p className="slide-p">Today we talk about our favorite room in the house!</p>
        </div>
      ),
    },
    // 2: House Warm-Up
    ...
    // 9: My Favorite Room Challenge
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="the finished dream room" size={110} onZoom={onZoom} />
        </div>
      ),
    },
    // 10: Wrap-up
