    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Simple Sentences!</h1></span>
          <p className="slide-p">Today we learn to say "It has..." to describe a person.</p>
      ...
      body: (
        <>
          ...
          <div className="word-row">
            ...
            <div className="combo"><DescriptorTag label="Small" color={SIZE_COLOR.Small} onZoom={onZoom} /><WordCard src={null} word="Nose" label="nose" onZoom={onZoom} /></div>
          </div>
        </>
      ),
    },
