    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">How Are You?</h1></span>
          <p className="slide-p">Today we talk about feelings, ask "How are you?", and learn the letters D, E, and F.</p>
