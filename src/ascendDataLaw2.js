// ASCEND Law & Advocacy — Lesson 2 — "The 90-Second Case" — Frame
...
export default {
  ...
  warmup: {
    kind: "synonyms",
    items: [
      { pre: "He clearly ", word: "broke the agreement", post: " with the supplier.", upgraded: "breach of contract" },
      { pre: "The company could face ", word: "legal trouble", post: " over this.", upgraded: "legal liability" },
      { pre: "We ran a ", word: "check to make sure the rules were followed", post: ".", upgraded: "compliance review" },
    ],
  },
  ...
  gimmick: {
    ...
    prompts: [
      "Should the firm take on this client, given the reputational risk?",
      "Should the client accept the settlement offer or go to trial?",
    ],
  },

  closing: { kind: "words", heading: "Before next lesson",
    body: "Write these down and keep them close — you'll need them next lesson.",
    words: ["conflict of interest", "burden of proof", "duty of confidentiality"] },
