    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">Free practice: body parts, describing, and -at / -og.</p>
        </div>
      ),
    },
    ...
    // 3: My Funny Person
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="blank funny character" size={110} onZoom={onZoom} />
    ...
    // 9: Show What You Know!
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="new unfamiliar character" size={110} onZoom={onZoom} />
        </div>
      ),
    },
    // 10: Great Job
