    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="center-col">
          <span className="title-highlight"><h1 className="slide-h">Let's Describe!</h1></span>
          <p className="slide-p">Today we learn more body parts, describing words, and the -og family.</p>
